...
class Problem_Interface():
    def __init__(self,gene_set,gene_l):
        """
        :return: None
        ...
        self.genes = gene_set
        self.gene_l = gene_l
        self.sol = 'ceci est un secret a retrouver'
    ...
    def evaluate_fitness(self, individu):
        ...
        """
        S1 = individu.get_value()[1]

        f = 0
        for x in range(self.gene_l):
            f += abs(LETTERS.index(S1[x]) - LETTERS.index(self.sol[x]))

...
class AlgoGen():
    ...
    def next_generation(self):
        """
        Calculating the next_generation start by getting a half population of the selection from the old population,
        and the other half from crossover with the old population.
        then we get the best five individues from the old popuation and we add them to the new population after extracting the worst 5.
        """
        c1 = self.selection()
